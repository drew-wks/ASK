#put everythin in a main becuase strealit willr ead that immediately upon importing the script, otherwise it will try to execute everything it can get its hands on inside your file haha
...
#CONFIG: wandb
project = "ASK_inference.py" #for python script
